...
package com.cerberustek.alexandria.server;
...
public interface AlexandriaServer extends CerberusService {

    boolean hasTCP();
    boolean hasUDP();

    WorkerBoss getWorkerBoss();

    Batch openBatch(String name, String password) throws FileNotFoundException;
    void closeBatch(String name);
