...
public class NetDataReceptionEvent implements Event {

    private final MetaData data;
    private final NetValve valve;
    private final NetChannel channel;
    private final NetMetaChannel metaChannel;

    public NetDataReceptionEvent(MetaData data, NetValve valve, NetChannel channel, NetMetaChannel metaChannel) {
        this.data = data;
        this.valve = valve;
    ...
    public NetMetaChannel getMetaChannel() {
        return metaChannel;
    }
}
