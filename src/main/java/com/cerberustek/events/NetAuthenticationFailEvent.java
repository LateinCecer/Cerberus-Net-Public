...
public class NetAuthenticationFailEvent implements Event {

    private final NetSecurity security;

    public NetAuthenticationFailEvent(NetSecurity security) {
        this.security = security;
    }

    public NetSecurity getSecurity() {
        return security;
    }
}
