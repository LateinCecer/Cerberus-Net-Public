...
public class WaitingConsumerTask extends WaiterTaskImpl {

    private final Consumer<Double> consumer;

    public WaitingConsumerTask(WorkerPriority priority, Consumer<Double> consumer) {
        super(priority);
        this.consumer = consumer;
    }

    public WaitingConsumerTask(WorkerPriority priority, long lastFrame, Consumer<Double> consumer) {
