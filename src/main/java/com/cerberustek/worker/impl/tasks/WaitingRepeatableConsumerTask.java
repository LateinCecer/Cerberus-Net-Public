...
public class WaitingRepeatableConsumerTask extends WaitingRepeatableTaskImpl {

    private final BiConsumer<Double, Integer> consumer;

    public WaitingRepeatableConsumerTask(WorkerPriority priority, int repetitions, BiConsumer<Double, Integer> consumer) {
        super(priority, repetitions);
        this.consumer = consumer;
    }

    public WaitingRepeatableConsumerTask(WorkerPriority priority, long lastFrame, int repetitions, BiConsumer<Double, Integer> consumer) {
