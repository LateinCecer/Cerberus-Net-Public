...
public abstract class WaitingRepeatableTaskImpl extends WaiterTaskImpl implements RepeatableTask {

    protected int repetitions;

    public WaitingRepeatableTaskImpl(WorkerPriority priority, int repetitions) {
        super(priority);
        this.repetitions = repetitions;
    }

    public WaitingRepeatableTaskImpl(WorkerPriority priority, long lastFrame, int repetitions) {
