...
public class ConsumerTask extends WorkerTaskImpl {

    private final Consumer<Double> consumer;

    public ConsumerTask(WorkerPriority priority, Consumer<Double> consumer) {
        super(priority, System.nanoTime());
        this.consumer = consumer;
    }

    ConsumerTask(WorkerPriority priority, long lastFrame, Consumer<Double> consumer) {
