...
public class RepeatableConsumerTask extends RepeatableTaskImpl {

    private final BiConsumer<Double, Integer> consumer;

    public RepeatableConsumerTask(WorkerPriority priority, int repetitions, BiConsumer<Double, Integer> consumer) {
        super(priority, repetitions);
        this.consumer = consumer;
    }

    public RepeatableConsumerTask(WorkerPriority priority, long lastFrame, int repetitions, BiConsumer<Double, Integer> consumer) {
