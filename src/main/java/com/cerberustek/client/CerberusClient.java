...
package com.cerberustek.client;
...
public interface CerberusClient {
    ...
    void connect(InetSocketAddress host) throws IOException;
    void disconnect();

    int getTimeOutDelay();
    void setTimeOutDelay(int timeOutDelay);

    int getHandshakeInterval();
    void setHandshakeInterval(int handshakeInterval);
