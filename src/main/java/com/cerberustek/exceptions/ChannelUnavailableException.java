...
public class ChannelUnavailableException extends Exception {

    private final short channelId;

    public ChannelUnavailableException(short channelId) {
        super("Cannot open channel width id: " + channelId + "!");
