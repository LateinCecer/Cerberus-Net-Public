...
public class ClientTimeoutException extends IOException {

    private final NetValve valve;
    private final int timeOut;

    public ClientTimeoutException(NetValve valve, int timeOut) {
        super("Valve has not responded in " + timeOut + "ms!");
        this.valve = valve;
